...
2. Установите словари и прочее `sudo apt install aspell aspell-en aspell-ru aspell-uk catdoc djvulibre-bin ffmpeg fonts-noto-core imagemagick npm pandoc python3-venv sox texlive-latex-base texlive-latex-recommended wkhtmltopdf`
