...
/web - опубликовать последний ответ бота в телеграфе
...
4. Перейдите в директорию проекта:
   ...
   Тут надо будет закоментировать строчку с gradio в requirements.txt, в после установки вручную установить нужную версию. Или не возвращать. С более свежей версией у меня на сервере памяти не хватает.
