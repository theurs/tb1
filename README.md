...
* Может сделать сам субтитры для ютуб видео у которого их нет, любого размера. И потом отвечать на вопросы по этим субтитрами, пересказывать.
...
/gemini10 - поменять модель джемини на 1.0
