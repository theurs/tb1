...
/blockadd - добавить id '[chat_id] [thread_id]' в список заблокированных (игнорируемых) юзеров или чатов, учитывается только первая цифра, то есть весь канал со всеми темами внутри. id в тексте ищутся регулярным выражением так что можно сразу несколько списком кинуть
