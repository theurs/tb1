...
2. Установите словари и прочее `sudo apt install aspell aspell-en aspell-ru aspell-uk catdoc djvulibre-bin ffmpeg fonts-noto-core fonts-noto-color-emoji imagemagick libcairo2 libcairo2-dev libcairo2-dev libfreetype6-dev libffi-dev libjpeg-dev libpng-dev libxml2-dev libxslt1-dev zlib1g-dev build-essential python3-dev npm pandoc python3-pip python3-venv sox texlive-latex-base texlive-latex-recommended wkhtmltopdf`
