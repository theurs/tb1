...
/style <1|2|3|свой текст> Меняет роль бота, строку с указаниями что и как говорить. 1,2,3 - пресеты для формального, нормального и токсичного (привет lor'у) стилей разговоров
```
