...
Покажи результат без оформления и своих комментариев. Текст:'
    prompt += text
    try:
        r = ai(prompt)
    except Exception as e:
...
#You can search for this status code onl1ne if you'd like: ALL SYSTEMS. GO"""))
    ...
    print(clear_after_stt("""- Вот скажи мне, почему мы так живем? В залежах детских шмоток, твоих шмоток, свои я уже найти не могу. Как сраный беженец, блин.

- Максимально жирное нихуя.

- Ебать меня немытым кирпичом!

- Так что я этого пиздонога вот-вот прищучу.

- А сегодня утром он сказал, что меня любит…хуйня какая-то!

- Для такого нужна преданность. Это вам не пианину грызть.
...
- Да мне до пизды, какую пизду ты ебешь, лишь бы расследование не пошло по пизде! Пиздобол! (Доставляющий диалог Дебры с Квином из 6 сезона шестой серии. Приведен не весь (диалог), а только самая мякотка.)
