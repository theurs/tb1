...
def ai(
    ...
    try:
        ...
        systems = (
            ...
            'You (assistant) can use some telegram bot functions, assistants answer starting /tts text-to-say and user will get voice message from you to user, assistants answer starting /img detailed-professional-description-of-an-image and user will get images generated by ai.',
