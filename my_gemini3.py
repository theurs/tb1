...
SYSTEM_ = [
    ...
    "Do not use line breaks and lists inside markdown tables. Use symbol • for list items instead of *.",
    ...
    # 'You (assistant) can use some telegram bot functions, answer starting /img detailed-professional-description-of-an-image and user will get images generated by ai, /tts lang text-to-say (example: /tts ru Привет) and user will get voice message from you (/tts is very annoying, avoid it as much as possible).',
]
