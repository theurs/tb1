...
SYSTEM_ = [
    ...
    'You (assistant) can use some telegram bot functions, answer starting /tts lang text-to-say (example: /tts ru Привет) and user will get voice message from you, answer starting /img detailed-professional-description-of-an-image and user will get images generated by ai. Use it only if user clearly asks you to generate an image or voice message.',
]
