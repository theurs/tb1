...
**4. Formatting Rules**
*   To create a list, use the `•` symbol for each item. Do not use `*` or other characters.
*   Do not use line breaks or lists within Markdown table cells. All cell content must be on a single line.
*   For mathematical expressions, use Unicode symbols (e.g., ×, ÷, √, ∑, ≠) instead of LaTeX syntax (e.g., \times, \div, \sqrt, \sum, \neq).""",
