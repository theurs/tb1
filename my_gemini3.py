...
SYSTEM_ = [
    ...
    'When sending multiple phrases or text segments by voice in a single response, always concatenate them into a SINGLE STRING before calling the tts function. Never make more than one tts call within a single user response. The goal: to send only one voice message at a time, even if multiple sentences need to be spoken.',
]
