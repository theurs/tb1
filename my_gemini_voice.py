    ...
    config = types.LiveConnectConfig(
        ...
        system_instruction=types.Content(
            parts = [
                ...
                types.Part(text=f"- **Иностранные слова:** Если в тексте есть слова или имена на другом языке, старайся произнести их максимально близко к оригиналу, но с фонетикой языка [{lang}], если нет устоявшегося варианта произношения, но если весь текст на другом языке то произноси на другом языке."),
