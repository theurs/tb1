...
PROMPT_SOLVE = "Solve the problem presented in the image, answer briefly. Rewrite LaTeX expressions with Unicode symbols (no markdown), if any. Don't mention the rewrite in the answer."
