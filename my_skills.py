...
def run_script(fname: str, text: str) -> str:
    ...
    It will run code for you - subprocess.check_output(f'./{fname}', shell=True, timeout=300, stderr=subprocess.DEVNULL)
    ...
    try:
        ...
        output = subprocess.check_output(f'./{fname}', shell=True, timeout=300, stderr=subprocess.DEVNULL)
