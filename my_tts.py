...
def tts_text_with_gpt(text: str) -> str:
    ...
    for chunk in utils.split_text(text, 2500):
        prompt = f"""Исправь текст так что бы русский TTS мог его прочитать,
он сам не может обработать цифры и не русские буквы,
смайлики и необычные символы надо заменить на словесное описание,
надо заменить в тексте цифры словами 10 -> десять,
английские надписи русскими (транслитерировать) mail -> мэил,
абревиатуры надо записать по слогам как они читаются HTTP -> эйч ти ти пи,
веб ссылки переписать так что бы их удобно было зачитывать вслух https://vk.ru/id=135127 -> сайт вэ ка точка ру, ай ди один три пять один два семь,
...
if __name__ == "__main__":
    ...
    text = """🤑🏠За 30 квадратов – 140 тысяч: цены на аренду жилья бьют рекорды во Владивостоке

Цены на аренду жилья летом бьют рекорды во Владивостоке. Стоимость отдельных предложений достигает (https://primamedia.ru/) 100-150 тысяч рублей за 30-40 кв. метров в "элитном" районе. По словам экспертов, эти примеры не отражают общей статистики, но цены действительно выросли. Помимо сезонного фактора, на них влияет рост турпотока и трудовой миграции в дальневосточную столицу

В базе Циан средняя стоимость аренды однокомнатной квартиры во Владивостоке составила 30 тысяч рублей в июне текущего года. Агентства недвижимости приводят цифры 33-35 тысяч рублей. С июля прошлого года ставки прибавили 4-6 тысяч рублей.


✅🧰Во Владивостоке завершилась реконструкция стадиона «Авангард». На днях его посетил корпус общественных наблюдателей 

13 июля стадион начнет работу - здесь пройдёт открытие спидвейного сезона. Команда «Восток» будет принимать «Турбину» из Балаково в рамках Командного Чемпионата России.


🛃🚘Владивостокская таможня за январь-июнь 2023 года оформила более 130 000 авто для личного пользования. Это в 2 раза больше, чем в первом полугодии прошлого года. 

Физлица продолжают активно везти подержанные автомобили через Дальний Восток – в основном японские и корейские 

Июнь стал рекордным по количеству оформленных машин - более 28 000 шт., побив на несколько сотен машин рекорд ноября прошлого года. По-прежнему около 80% занимают автомобили из Японии: Toyota, Mazda, Nissan, Honda, Subaru. Далее корейский автопром: Hyundai, Genesis, SsangYong, Kia, и единицы из Китая. 
 
Резкий рост ввоза иномарок произошел в прошлом году из-за ряда факторов: введенных санкций в отношении России, ухода с российского рынка крупных международных автомобильных компаний, выгодного курса валют и дефицита новых автомобилей, что продолжает сохранять динамику ввоза автомобилей на сегодняшний день.
