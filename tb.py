...
def users_keys_for_gemini(message: telebot.types.Message):
    ...
    bot_reply_tr(message, 'Usage: /keys GEMINI API KEYS space separated\n\nThis bot needs free api keys. Get it at https://ai.google.dev/ Howto video https://www.youtube.com/watch?v=6aj5a7qGcb4')
...
@bot.message_handler(commands=['image','img','i', 'imagine', 'imagine:', 'generate', 'gen'], func=authorized)
