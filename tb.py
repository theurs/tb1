...
'ask_image' - если пользователь задает вопрос об изображении, просит его описать, анализировать его содержимое, или использует изображение как КОНТЕКСТ для текстового запроса (например, "что это за здание?", "какую породу собаки на фото?", "опиши атмосферу"), в запросе есть любые намёки на школьные задания, решение задач.
