            ...
            with ShowAction(message, 'upload_audio'):
                ...
                try:
                    ...
                    if caption_:
                        ...
                        caption_ = caption
                    caption_ += f'\n<a href = "https://youtu.be/{song_id}">{tr("Посмотреть на ютубе", lang)}</a>' + f' #{chat_id_full}'
    ...
    with semaphore_talks:
        with ShowAction(message, 'record_audio'):
            ...
            if audio:
                ...
                my_log.log_echo(message, f'[Отправил голосовое сообщение] [{gender}]')
            else:
        ...
        if len(prompt) > 1:
            ...
            with ShowAction(message, 'upload_photo'):
                ...
                if len(medias) > 0:
                    ...
                    if pics_group:
                        try:
                            bot.send_message(cfg.pics_group, f'{prompt}\n\n#{chat_id_full}', disable_web_page_preview = True)
