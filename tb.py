...
Чат-боты могут принимать тексты больше чем 4096 символов, телеграм клиент их автоматически разбивает на части а бот собирает обратно, ограничения для чат-ботов такие:
