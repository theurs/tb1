...
'''
    if hasattr(cfg, 'TRIALS'):
        ...
        d = tr("The bot is free to use for a certain number of days and messages, but once you've used up all your days and messages, the bot will ask you for a donation to continue using it. Alternatively, you can choose to run your own free, unlimited copy of the bot on your own computer.", lang)
        msg += f'{d}\n'
