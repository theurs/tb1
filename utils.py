...
## Сравнение кукушкина льна и сфагнума:

| Критерий | Кукушкин лен | Сфагнум |
|---|---|---|
| **Стебли** | Прямостоячие, неветвящиеся, достаточно жесткие. | Мягкие, ветвящиеся, образуют плотные дерновинки. |
| **Листья** | Мелкие, узкие, заостренные, однородные, расположены по спирали. | Мелкие, чешуйчатые, двух типов: мелкие зеленые хлорофиллоносные и крупные бесцветные водоносные. |
| **Наличие ризоидов** | Присутствуют у молодого растения, выполняют функцию корней. | У взрослого растения отсутствуют. |
| **Коробочка** | На длинной ножке, имеет крышечку (спорофит). | На короткой ножке, без крышечки (спорофит). |
| **Наличие воздушных клеток** | Отсутствуют. | Присутствуют в водоносных листьях, обеспечивают высокую влагоемкость. |
| **Окраска растения** | Ярко-зеленая. | Бледно-зеленая, может быть желтоватой, буроватой или красноватой. |
| **Количество накапливаемой влаги** | Незначительное. | Значительное (в 20-25 раз больше собственной массы). |
| **Где растёт** | Влажные места, болота, леса, преимущественно на кочках. | Верховые болота, образует сплошной ковер,  влажные леса. |
| **Образует ли централизованное управление кадрами централизованное управление кадрами торф** | Нет. | Да, благодаря особым свойствам: медленному разложению и высокой влагоемкости. |


**Таблица 3. Морфология опухолей и опухолеподобных образований из меланинсодержащей ткани.**
