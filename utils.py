...
gpt_start_message = [{"role":       "system",
                     ...
                     {"role":       "user",
                      "content":    "Отвечай с подходящим к запросу типом юмора или иронии, шутка не должна бросаться в глаза, в первом ответе особенно. Отвечай по-русски, используй мужской род."},
